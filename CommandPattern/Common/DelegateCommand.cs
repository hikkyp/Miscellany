...
namespace CommandPattern.Common
{
	public class DelegateCommand<T> : DelegateCommandBase
	{
		...
		private DelegateCommand (Func<T, Task> execute, Predicate<T> canExecute)
		...
		public static DelegateCommand<T> FromAsyncHandler (Func<T, Task> execute, Predicate<T> canExecute)
		{
